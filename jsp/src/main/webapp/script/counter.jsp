<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- 
	선언문(Declaration) : 필드 또는 메소드를 선언하는 영역 제공 
	=> 요청처리가 아닌 서블릿 클래스의 명령으로 해석
--%>
<%!
	/*
		서블릿 클래스의 객체에 필요한 값을 저장하기 위한 필드
		=> 필드는 서블릿 객체가 메모리에서 없어지면(WAS 종료되면) 자동 소멸
	*/
	int count=0;
%>
...
<body>
	...
	<p>JSP 문서의 요청 횟수 = <% out.println(count); %></p>
		...
		표현식(Expression) : 값(변수값, 연산 결과값, 메소드 반환값)을 제공받아 응답파일에 포함하기 위한 영역 제공
	--%>
