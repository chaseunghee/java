...
public class RegularExpressionApp {
	public static void main(String[] args) {
		...
		//비밀번호 형식(패턴) : 영문자,숫자,특수문자가 1번 이상 포함되며
		//8~30 범위의 문자들로 구성된 문자열 
		System.out.print("비밀번호 입력 >> ");
		String pw=scanner.nextLine();
		
		if(pw==null || pw.equals("")) {//사용자 입력값이 없는 경우
			System.out.println("[에러]비밀번호를 반드시 입력해주세요.");
			System.exit(0);
		}
		
		//비밀번호 패턴을 정규표현식으로 표현하여 저장
		...
		System.out.println("[메세지]형식에 맞는 비밀번호를 입력했습니다.");
