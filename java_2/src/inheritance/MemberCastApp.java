...
public class MemberCastApp {
	public static void main(String[] args) {
		...
		//=> 부모클래스의 생성자로 부모클래스 객체를 생성하고 자식클래스의 생성자로 자식 클래스의 객체를 생성하여
		//	  자식클래스의 참조변수에 자식클래스의 객체 저장
		...
		//자식클래스 참조변수=new부모클래스();
		//=> 부모클래스의 생성자로 부모클래스 객체를 생성하고 자식클래스의 참조변수에 부모클래스의 객체 저장
		...
		//=> 자식클래스 객체를 참조할 수 없으므로 부모클래스도 호출 가능
		...
		//						자식클래스로 변경하면 참조변수에 자식클래스의 객체가 자동 저장
		...
		*/
		...
		//.연산자보다 Cast 연산자가 먼저 실행되므로 ()연산자 사용
		((MemberEvent)member4).setEmail("opq@itwill.xyz");
		
		//((MemberEvent)member4).display();
		//묵시적 객체 형변환 : 부모클래스의 메소드를 자식클래스에서 오버라이드 선언하면 
		//						부모클래스의 숨겨진 메소드 대신 자식클래스의 메소드를 호출하기 위해 
		//						참조면수의 자료형을 자동으로 자식클래스로 변경하여 일시적으로 자식클래스의
		//						객체가 참조변수에 저장되어 자식클래스의 메소드 호출
		member4.display();
		System.out.println("=============================================================");
