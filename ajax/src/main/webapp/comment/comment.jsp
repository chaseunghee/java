...
<body>
	...
	/*
		...
		=> 입력태그의 입력값(댓글정보)을 반환받아 AJAX_COMMENT 테이블에 댓글정보를 삽입하는 [comment_add.jsp] 문서를 AJAX 기능으로 요청하고 실행결과를 JSON 데이타로 응답받아 처리
	*/
	...
	/*
		...
		=> 댓글변경태그를 댓글태그에 자식태그로 이동하여 출력하고 [comment_get.jsp] 문서를 AJAX 기능으로 요청하여 실행결과를 JSON 데이타로 응답받아 입력태그의 입력값으로 변경
	*/
	...
	/*
		댓글변경태그에서 [변경] 태그를 클릭한 경우 호출되는 이벤트 처리 함수 등록
		 => 입력태그의 입력값(댓글정보)을 반환받아 AJAX_COMMENT 테이블에 저장된 댓글정보를 변경하는 [comment_modify.jsp] 문서를 AJAX 기능으로 요청하고 실행결과를 JSON 데이타로 응답받아 처리
	*/
	...
	*/
	...
	/*
		...
		=> 입력태그의 입력값(댓글번호)을 반환받아 AJAX_COMMENT 테이블에 저장된 댓글정보를 삭제하는 [comment_remove.jsp] 문서를 AJAX 기능으로 요청하고 실행결과를 JSON 데이타로 응답받아 처리
	*/
