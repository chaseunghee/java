...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- Member 객체를 생성하여 Request Scope 속성값으로 저장하고 다른 웹프로그램(JSP)으로 포워드 이동하는 JSP 문서  - 요청을 처리하는 웹프로그램(Model) --%>
<%
	...
	*/
	...
	/*
		포워드 이동 : 현재 웹프로그램의 명령을 실행하는 스레드를 다른 웹프로그램으로 이동시켜 명령을 실행하여 응답 처리하기 위한 기능 제공
