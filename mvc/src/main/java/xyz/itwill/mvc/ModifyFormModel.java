...
/*
	...
	=> 관리자만 요청 가능하도록 권한 설정
	=> 아이디를 전달받아 USERINFO 테이블에 저장된 회원정보를 검색하여 request 객체의 속성값으로 저장하고 [user_modify.jsp]로 포워드 이동하기 위한 정보가 저장된 ActionForward 객체 반환
*/
public class ModifyFormModel implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			/*
				UserinfoService 클래스의 getUserinfo() 메소드를 호출하여 검색된 회원정보를 DTO 객체로 반환받아 request 객체의 속성값 저장
				=> UserinfoService 클래스의 getUserinfo() 메소드를 호출하여 검색된 회원정보가 없는 경우 UserinfoNotFoundException 발생 - 비정상적인 요청
			*/
