...
<%-- 
	변경 게시글을 전달받아 REVIEW 테이블에 저장된 게시글을 변경하고 [review/review_detail.jsp] 문서로 이동하기 위한 URL 주소를 클라이언트에게 전달하여 응답하는 JSP 문서
	=> [review/review_detial.jsp] 문서로 글번호, 페이지번호, 검색대상, 검색단어 전달
	=> 로그인 상태의 사용자 중 게시글 작성자이거나 관리자인 경우에만 요청 가능한 
--%>
