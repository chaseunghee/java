<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- 
	비로그인 상태의 사용자인 경우 사용자로부터 로그인 처리에 필요한 인증정보(아이디와 비밀번호)를 입력받는 JSP 문서
	=> [로그인] 태그를 클릭한 경우 [login_action.jsp] 문서 요청 - 입력값(인증정보) 전달 
	...
	*/
	...
	if(message==null){
		message="";
			...
			//session.removeAttribute(String attributeName) : 클라이언트의 정보(JESSIONID 쿠키)로 바인딩된 세션(session)에서 매개변수로 전달된 속성명의 속성값(객체)을 삭제하는 메소드
...
<body>
	...
	<h1>로그인</h1>
	<hr>
	<form action="login_action.jsp" method="post" name="loginForm">	<table>
		<tr>
			<td>아이디</td>
