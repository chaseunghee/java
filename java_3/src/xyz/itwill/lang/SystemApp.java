...
//Java API(Applicatio Programming Interface) : Java 프로그램 개발에 프로그램 기능을 제공하기 위한 도구
//=> 라이브러리를 이용하여 배포된 Java 자료형 (클래스, 인터페이스, 열거형)
//=> API 문서를 활용하여 Java 자료형에 대한 설명을 제공받아 사용
//=> 온라인 API 문서 : http://docs.oracle.com/en/java/javase/17/docs/api/index.html
...
public class SystemApp {
	public static void main(String[] args) {
		...
		//System.currentTimeMillis() : 시스템의 현재 날짜와 시간에 대한 타임스탬프(TimeStamp)를 반환하는 메소드
		//타임스탬프(TimeStamp) : 날짜와 시간을 정수값으로 표현하기 위해 만들어진 시간값
		...
		//System.gc(): 메모리를 청소하는 프로그램(Garbage Collector)을 실행하는 메9소드
		System.gc();
