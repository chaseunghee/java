...
/*
	...
	=> USEINFO 테이블에 저장된 모든 회원정보를 검색하여 request 객체의 속성값으로 저장하고 [user_list.jsp]로 포워드 이동하기 위한 정보가 저장된 ActionForward 객체 반환
*/
public class ListModel implements Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			/*
				UserinfoService 클래스의 getUserinfoList() 메소드를 호출하여 검색된 회원목록을 List 객체로 반환받아 request 객체의 속성값 저장
