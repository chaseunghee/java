<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!-- 
	회원정보를 전달받아 내장객체의 속성값으로 저장하고 [useBean_display.jsp] 문서로 포워드 이동하는 JSP 문서 - 클라이언트 요청에 대한 처리만 제공하는 JSP 문서
-->
<%
...
<%--
	...
	=> 내장객체에 저장된 속성값을 객체로 반환받아 제공하거나 속성값이 없는 경우 객체를 생성하여 내장객체의 속성값으로 저장하여 제공
...
<%-- 
	...
	=> JSP 문서 요청시 전달된 값의 이름과 setProperty 태그의 property 속성값(객체 필드명)이 반드시 동일해야만 전달값을 반환받아 객체 필드값으로 변경 
--%>
<%--
