...
//[순서-30] - ModelController 클래스 생성 및 코드 작성
@Controller
public class ModelController {
	...
	/* [순서-32] - 아래 코드 작성
		...
		@ModelAttribute : 메소드에 @ModelAttribute 어노테이션을 사용하면 메소드에 의해 반환되는 객체(값)을 현재 Controller 클래스에 작성된 
						  모든 요청 처리 메소드의 뷰에게 제공하는 어노테이션
