...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- 아이디 검색 관련 정보를 전달받아 MEMBER 테이블에 저장된 회원정보의 아이디를 검색하여 클라이언트에게 전달하여 응답하는 JSP 문서 --%>
<%
	...
	*/
	...
	//회원정보(아이디와 이름)를 전달받아 MEMBER 테이블에 저장된 회원정보의 아이디를 검색하여 문자열(String 객체)로 반환하는 DAO 클래스의 메소드 호출
