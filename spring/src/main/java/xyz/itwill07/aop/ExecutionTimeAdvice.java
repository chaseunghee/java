...
/*
//[순서-7] ExecutionTimeAdvice 클래스 생성 
public class ExecutionTimeAdvice {
	//타겟메소드의 명령이 실행되는 처리 시간을 계산하여 기록하기 위한 메소드 - Around Advice Method
	public Object timeWatchLog(ProceedingJoinPoint joinPoint) throws Throwable {//반환형 - object
		//타겟메소드의 명령 실행 전에 동작될 명령 작성
		long startTime=System.currentTimeMillis();
		
		//타겟메소드의 명령 실행 - 타겟메소드 호출 (방법 : joinPoint.proceed)
