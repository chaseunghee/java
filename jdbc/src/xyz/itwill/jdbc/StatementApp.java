...
/*
	Statement 객체 : 현재 접속중인 DBMS 서버에 SQL 명령을 전달하여 실행하기 위한 기능을 제공하는 객체
	 ...
	 - 단점 : SQL 명령에 Java 변수값을 포함할 경우 문자열 결합 기능 사용
	    => 문자열 결합을 이요할 경우 가독성 및 유지보수의 효율성 감소
...
public class StatementApp {
	...
	/* 
		//키보드로 학생정보를 입력받아 STUDENT 테이블에 삽입하고 STUDENT 테이블에 저장된 모든 학생 정보를 검색하여 출력하는 JDBC 프로그램 작성
	...
	*/
	...
	/*단점 예시 코드*/
		...
		System.out.print("이름 입력 >> "); //-> ' or '1'='1 입력하고 엔터
		String name=in.readLine();
