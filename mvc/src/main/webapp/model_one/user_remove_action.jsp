...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- 
	아이디를 전달받아 USERINFO 테이블에 저장된 회원정보를 삭제하고 [user_list.jsp] 문서를 요청하는 URL 주소를 클라이언트에게 전달하여 응답하는 JSP 문서 - 관리자만 요청 가능한 JSP 문서 
	=> 현재 로그인 관리자가 자신의 회원정보를 삭제한 경우 [user_logout_action.jsp] 문서를 요청하는 URL 주소를 클라이언트에게 전달하여 응답 
--%>    
<%
