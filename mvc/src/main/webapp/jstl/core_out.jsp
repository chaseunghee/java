...
<body>
	...
	<%-- EL를 사용하여 스코프 객체의 속성값으로 HTML 태그가 포함된 문자열을 제공받아 출력할 경우 HTML 태그로 태그로 인식하여 출력 처리  --%>
	<p>html = ${html }</p>
	<hr>
	
	<%-- out 태그를 사용하여 스코프 객체의 속성값으로 HTML 태그가 포함된 문자열을 제공받아 출력할 경우 HTML 태그를 문자로 인식하여 출력 처리 --%> 
