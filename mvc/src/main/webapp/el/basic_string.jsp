...
<%	
	...
	*/
	pageContext.setAttribute("name", "홍길동");// name이라는 이름으로 홍길동 저장 
%>   
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<%
		/*
			pageContext.getAttribute(String attributeName) : pageContext 내장객체에 저장된 스코프 속성값을 속성명을 이용하여 객체로 반환하는 메소드
	...
	<p>이름(name) = <%=name %></p>
	<%-- 반환받은 객체가 [null]인 경우 JSP 표현식은 "null" 문자열로 변환되어 출력 처리 => null은 값이 없음을 의미하는데 문자열로 변환되어 출력하기 때문에 if문을 사용하여 정의--%>
