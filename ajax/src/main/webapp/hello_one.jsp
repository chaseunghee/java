...
<body>
	...
	<button type="button" id="btn2">배경색변경</button>
	</div>
	...
	*/
	...
	document.getElementById("btn1").onclick=function() {
		/*
			AJAX(Asynchronous Javascript + XML) 기능을 이용하여 응답결과를 제공받아 페이지의 태그 변경
			=> XMLHttpRequest 객체를 사용하여 비동기식으로 웹프로그램을 요청하여 실행결과를 HTML 또는 XML로 응답받아 페이지의 태그 변경 처리
		*/
		
		
		/*
			1. XMLHttpRequest 객체를 생성하여 전역변수에 저장
		*/
		...
		/*
			...
			=> 0 : XMLHttpRequest 객체 생성, 1 : open() 메소드 호출 - 웹프로그램 요청 설정, 2 : send 메소드() 호출 -  웹프로그램 요청, 3 : 웹프로그램 실행, 4 : 실행결과 응답 
		*/
