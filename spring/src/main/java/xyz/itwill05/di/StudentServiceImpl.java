...
/*
	...
	=> Service 클래스가 변경돼도 Service 클래스를 사용하는 클래스(컨트롤러 - 모델)에 영향을 최소화하기 위해 반드시 인터페이스 상속받아 작성 - 결합도를 낮춰 유지보수의 효율성 증가
*/
...
public class StudentServiceImpl implements StudentService{
	/*
		...
		=> StudentServiceImpl 클래스의 메소드에서 필드에 저장된 StudentJdbcDAO 객체로 메소드 호출
	...
	*/
	...
	/*
		...
		=> StudentServiceImpl 클래스의 메소드에서 인터페이스로 생성된 필드의 추상메소드를 호출하면 필드에 저장된 자식클래스 객체의 메소드 호출 - 오버라이딩에 의한 다형성
		=> DAO 클래스가 변경돼도 Service 클래스의 영향 최소화 - 결합도를 낯춰 유지보수의 효율성 증가
	*/
