...
public class FileBoardServiceImpl implements FileBoardService {
	...
	*/
	...
	//매개변수로 요청 페이지 번호를 전달받아 게시글 목록이 저장된 객체와 페이지 번호 관련 객체를 Map 객체의 엔트리로 추가하여 반환하는 메소드
	@Override
	public Map<String, Object> getFileBoardList(int pageNum) {
		...
		*/
		...
		//FileBoardDAO 클래스의 selectFileBoardList() 메소드를 호출하기 위해 매개변수에 전달하여 저장될 Map 객체(시작 행번호, 종료 행번호) 생성
