...
<%@ page language="java" contentType="text/xml; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- 이름과 이메일을 전달받아 AJAX_MEMBER 테이블에 저장된 회원정보의 아이디를 검색하여 XML 데이타로 응답하는 JSP 문서 --%>
<%
...
%>
<result>
	<% if(id!=null) {//검색된 아이디(DAO의 id)가 있는 경우 - code라는 엘리먼트에 success %>
	<code>success</code>
	<id><%=id%></id>
	<% } else {//검색된 아이디가 없는 경우 - code라는 엘리먼트에 empty %>
	<code>empty</code> 
	<% } %>
</result>
