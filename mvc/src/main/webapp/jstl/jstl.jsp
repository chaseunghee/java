...
<body>
	...
	<%-- 
		https://tomcat.apache.org >> Download >> Taglibs 메뉴 클릭 >> taglibs-standard-impl-1.2.5.jar,taglibs-standard-spec-1.2.5.jar,
			taglibs-standard-jstlel-1.2.5.jar,taglibs-standard-compat-1.2.5.jar 파일 다운로드 >> /WEB-INF/lib 폴더에 jar 파일 붙여넣기 : 프로젝트에 라이브러리 빌드 처리 
	--%>
	<hr>
