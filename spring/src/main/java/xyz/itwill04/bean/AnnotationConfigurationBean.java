...
/*
	@Configuration : 스프링 컨테이너에 의해 관리될 객체(Spring Bean)을 생성하여 반환하는 메소드가 선언된 클래스를 설정하기 위한 어노테이션
