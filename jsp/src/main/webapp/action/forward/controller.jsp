...
<%
	...
	if(pageName==null) {//전달값이 없는 경우
		/*
			...
			=> URL 주소를 응답받은 클라이언트는 브라우저의 요청 URL 주소를 변경하여 서버의 JSP 문서를 요청하여 실행결과(웹문서)를 응답받아 출력 - 리다이렉트 이동
		*/
...
<%--
	forward Tag : 요청 JSP 문서에서 다른 JSP 문서를 스레드를 이동하여 스레드가 이동된 JSP 문서로 응답 처리하기 위한 기능을 제공하는 태그 - 서버측
