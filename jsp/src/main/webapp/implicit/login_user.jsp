...
<body>
	...
	<%--
		절대경로에서 웹자원이 저장된 컨텍스트 디렉토리 경로는 request 객체의 getContextPath() 메소드를 호출하여 반환받아 사용
