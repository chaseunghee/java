...
public class TypeCastApp {
	public static void main(String[] args) {
		//자동 형변환: 자료형이 다른 값을 연산하기 위한 JVM(Java Virtual Machine)이 자료형을 변환
		//프로그램을 실행하기 위한 가상의 플랫폼이 자료형을 일시적으로 변환
		//=> 표현의 범위가 작은 자료형의 값이 큰 자료형의 값으로 형변환되어 연산 처리
		//=> byte >> short >> char >> int >> long >> float >> double
		System.out.println("결과 = "+(3.15)); //3(int)+1.5(double) >> 3.0(double)+1.5(double) >> 4.5(double)
		...
		//double ave=tot/2; //평균 계산 - 연산 결과값 : 정수값(92) >> 실수값(92.0)으로 변환되어 
		double ave=tot/2.; //평균 계산 - 연산 결과값 : 실수값(92.5)
		System.out.println("총점 = "+tot+", 평균 = "+ave);
		
		//int 자료형보다 작은 자료형의 값은 무조건 int자료형으로 형변환되어 연산됨.
		byte su1=10, su2=20;
		//byte su3=su1+su2; //byte+byte >> int+int >> int
		int su3 = su1+su2;
		System.out.println("su3 = "+su3);
		System.out.println("==============================================================");
		
		//강제 형변환 : 프로그래머가 Cast 연산자를 사용하여 원하는 자료형의 값으로 일시적으로 변환하여 사용하는 방법
		...
		//큰 정수값은 _기호를 사용하여 표현 가능 ex)100_000_000
		int num4=100000000, num5=30;
		//정수값에 대한 연산 결과는 4Byte로 표현 - -2148483648~2147483647
		//문제점) 정수값에 대한 연산 결과값이 4Byte로 표현 가능한 범위를 벗어난 경우 쓰레기값 
