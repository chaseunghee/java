	...
	document.getElementById("newsList").onmouseover=function() {
		...
		xhr.onreadystatechange=function() {
			if(xhr.readyState==4) {
				if(xhr.status==200) {
					/*
						XMLHttpRequest.responseXML : 웹프로그램 요청에 대한 실행결과를 XML 문서로 응답받은 경우 응답결과가 저장된 프로퍼티 - XMLDocument 객체 제공
					...
					*/
					...
					/*
						Document.getElementsByTagName(tagName) : Document 객체(Element 객체)에서 태그명으로 태그를 검색하여 검색된 모든 태그(Element 객체)가 요소로 저장된 NodeList 객체를 반환하는 메소드
					*/
