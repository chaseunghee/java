...
/*
	...
	=> 회원정보를 전달받아 USERINFO 테이블에 회원정보로 삽입하고 [/loginform.do] 페이지로 리다이렉트 이동하기 위한 정보가 저장된 ActionForward 객체 반환
*/
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			/*
				...
				=> 전달받은 아이디가 USERINFO 테이블에 저장된 기존 회원정보의 아이디와 중복될 경우 ExistsUserinfoException 발생
			*/
