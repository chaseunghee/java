...
//[순서-25] - 10.controller >> ResultController 클래스 생성
...
public class ResultController {
	...
	*/
	...
	/*
		...
		=> 요청 처리 메소드에 매개변수를 작성하면 Front Controller는 스프링 컨테이너(WebApplicationContext 객체)에게 매개변수에 저장 가능한 객체(Spring Bean)를 제공받아 저장
	*/
	@RequestMapping("/resultMav")
