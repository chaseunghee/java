...
//=> 원시데이터를 인코딩 처리하여 원하는 문자형태의 문자데이터(2Byte))로 변환
// - 인코딩 : 문자형채(캐릭터셋 - CharSet)
...
public class CharacterStreamApp {
	public static void main(String[] args) throws IOException {
		...
		//InputStreamRead 클래스 : InputStream 객체를 전달받아 문자데이터를 입력받기 위한 
		//							입력스트림(Reader객체)를 생성하기 위한 클래스 - 스트림 확장
		InputStreamReader in = new InputStreamReader(System.in);
		
		//OutputStreamWriter 클래스 : OutputStream 객체를 전달받아 문자데이터를 출력하기 위한 
		//								출력스트림(Writer 객체)를 생성하기 위한 클래스 - 스트림 확장
		//OutputStreamWriter out = new OutputStreamWriter(System.out); 
		//출력스트림(Write 객체)를 생성하기 위한 클래스
